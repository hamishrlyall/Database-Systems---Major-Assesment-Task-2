...
(SELECT MAX(UNITPRICE)FROM A2SALEBRIS WHERE A2SALEBRIS.PRODID IN (SELECT d.DWSOURCEID FROM DWPROD d))/*SELECT MAX(UNITPRICE)FROM A2SALEBRIS WHERE A2SALEBRIS.PRODID = DWPROD.DWSOURCEID)*//*(SELECT p.PRODID FROM A2PRODUCT p))*/
FROM A2SALEBRIS          
