...
/
INSERT INTO A2ERROREVENT( ERRORID, SOURCE_ROWID, SOURCE_TABLE, FILTERID, DATETIME, ERRORCODE, ACTION )
SELECT A2ERROREVENT_SEQ.NEXTVAL AS ERRORID, ROWID, 'A2SALEMELB', 12, CURRENT_TIMESTAMP,328 , 'SKIP'
FROM A2SALEMELB m
WHERE m.PRODID NOT IN (SELECT p.DWSOURCEID FROM DWPROD p);
COMMIT;
/
INSERT INTO A2ERROREVENT( ERRORID, SOURCE_ROWID, SOURCE_TABLE, FILTERID, DATETIME, ERRORCODE, ACTION )
SELECT A2ERROREVENT_SEQ.NEXTVAL AS ERRORID, ROWID, 'A2SALEMELB', 13, CURRENT_TIMESTAMP,349 , 'SKIP'
FROM A2SALEMELB m
WHERE m.CUSTID NOT IN (SELECT c.DWSOURCEIDMELB FROM DWCUST c);
COMMIT;
/
INSERT INTO A2ERROREVENT( ERRORID, SOURCE_ROWID, SOURCE_TABLE, FILTERID, DATETIME, ERRORCODE, ACTION )
SELECT A2ERROREVENT_SEQ.NEXTVAL AS ERRORID, ROWID, 'A2SALEMELB', 14, CURRENT_TIMESTAMP,371 , 'MODIFY'
FROM A2SALEMELB m
WHERE m.SHIPDATE < m.SALEDATE;
/
INSERT INTO A2ERROREVENT( ERRORID, SOURCE_ROWID, SOURCE_TABLE, FILTERID, DATETIME, ERRORCODE, ACTION )
SELECT A2ERROREVENT_SEQ.NEXTVAL AS ERRORID, ROWID, 'A2SALEMELB', 15, CURRENT_TIMESTAMP,393 , 'MODIFY'
FROM A2SALEMELB m
