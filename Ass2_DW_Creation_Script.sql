...
SELECT DW_SEQ.NEXTVAL AS DWPRODID, 'A2PRODUCT', A2PRODUCT.PRODID, A2PRODUCT.PRODNAME, A2PRODCATEGORY.CATEGORYNAME, A2MANUFACTURER.MANUNAME, A2SHIPPING.DESCRIPTION
FROM A2PRODUCT
...
/
INSERT INTO DWPROD (DWPRODID, DWSOURCETABLE, DWSOURCEID, PRODNAME, PRODCATNAME, PRODMANUNAME, PRODSHIPNAME )
SELECT DW_SEQ.NEXTVAL AS DWPRODID, 'A2PRODUCT', A2PRODUCT.PRODID, A2PRODUCT.PRODNAME, A2PRODCATEGORY.CATEGORYNAME, 'UNKNOWN', A2SHIPPING.DESCRIPTION
FROM A2PRODUCT
INNER JOIN A2PRODCATEGORY ON A2PRODUCT.PRODCATEGORY = A2PRODCATEGORY.PRODUCTCATEGORY
INNER JOIN A2SHIPPING ON A2PRODUCT.SHIPPINGCODE = A2SHIPPING.SHIPPINGCODE
...
/
INSERT INTO DWPROD (DWPRODID, DWSOURCETABLE, DWSOURCEID, PRODNAME, PRODCATNAME, PRODMANUNAME, PRODSHIPNAME )
SELECT DW_SEQ.NEXTVAL AS DWPRODID, 'A2PRODUCT', A2PRODUCT.PRODID, A2PRODUCT.PRODNAME, 'UNKNOWN', A2MANUFACTURER.MANUNAME, A2SHIPPING.DESCRIPTION
FROM A2PRODUCT
INNER JOIN A2MANUFACTURER ON A2PRODUCT.MANUFACTURERCODE = A2MANUFACTURER.MANUCODE
INNER JOIN A2SHIPPING ON A2PRODUCT.SHIPPINGCODE = A2SHIPPING.SHIPPINGCODE
