...
VALUES (DWCUST_SEQ.NEXTVAL, CM.CUSTID, CM.FNAME, CM.SNAME, CM.GENDER, CM.PHONE, CM.POSTCODE, CM.CITY, CM."STATE", CM.CUSTCATNAME);
COMMIT;
/
INSERT INTO A2ERROREVENT( ERRORID, SOURCE_ROWID, SOURCE_TABLE, FILTERID, DATETIME, ERRORCODE, ACTION )
...
(SELECT DWCUSTID FROM DWCUST WHERE DWCUST.DWSOURCEIDBRIS=A2SALEBRIS.CUSTID),
(SELECT DWPRODID FROM DWPROD WHERE DWPROD.DWSOURCEID=A2SALEBRIS.PRODID),
A2SALEBRIS.SALEID,
A2SALEBRIS.QTY,
...
UNITPRICE
FROM A2SALEBRIS          
WHERE A2SALEBRIS.ROWID NOT IN (SELECT e.SOURCE_ROWID FROM A2ERROREVENT e);
COMMIT;
/
INSERT INTO DWSALE(DWSALEID, DWCUSTID, DWPRODID, DWSOURCEIDBRIS, QTY, SALE_DWDATEID, SHIP_DWDATEID, SALEPRICE)
SELECT DWSALE_SEQ.NEXTVAL,
...
UNITPRICE
FROM A2SALEBRIS          
WHERE A2SALEBRIS.ROWID IN (SELECT e.SOURCE_ROWID FROM A2ERROREVENT e WHERE e.FILTERID = 10);
COMMIT;
/
INSERT INTO DWSALE(DWSALEID, DWCUSTID, DWPRODID, DWSOURCEIDBRIS, QTY, SALE_DWDATEID, SHIP_DWDATEID, SALEPRICE)
SELECT DWSALE_SEQ.NEXTVAL,
...
A2SALEBRIS.SALEID,
A2SALEBRIS.QTY,
(SELECT DATEKEY FROM DWDATE WHERE DWDATE.DATEVALUE=A2SALEBRIS.SALEDATE),
(SELECT DATEKEY FROM DWDATE WHERE DWDATE.DATEVALUE=A2SALEBRIS.SHIPDATE),
(SELECT MAX(UNITPRICE)FROM A2SALEBRIS WHERE A2SALEBRIS.PRODID IN (SELECT d.DWSOURCEID FROM DWPROD d))
FROM A2SALEBRIS          
WHERE A2SALEBRIS.ROWID IN (SELECT e.SOURCE_ROWID FROM A2ERROREVENT e WHERE e.FILTERID = 11);
COMMIT;
/
INSERT INTO A2ERROREVENT( ERRORID, SOURCE_ROWID, SOURCE_TABLE, FILTERID, DATETIME, ERRORCODE, ACTION )
SELECT A2ERROREVENT_SEQ.NEXTVAL AS ERRORID, ROWID, 'A2SALEBRIS', 12, CURRENT_TIMESTAMP,328 , 'SKIP'
FROM A2SALEMELB m
WHERE m.PRODID NOT IN (SELECT p.DWSOURCEID FROM DWPROD p);
COMMIT;
/
INSERT INTO A2ERROREVENT( ERRORID, SOURCE_ROWID, SOURCE_TABLE, FILTERID, DATETIME, ERRORCODE, ACTION )
SELECT A2ERROREVENT_SEQ.NEXTVAL AS ERRORID, ROWID, 'A2SALEBRIS', 13, CURRENT_TIMESTAMP,349 , 'SKIP'
FROM A2SALEMELB m
WHERE m.CUSTID NOT IN (SELECT c.DWSOURCEIDMELB FROM DWCUST c);
COMMIT;
/
INSERT INTO A2ERROREVENT( ERRORID, SOURCE_ROWID, SOURCE_TABLE, FILTERID, DATETIME, ERRORCODE, ACTION )
SELECT A2ERROREVENT_SEQ.NEXTVAL AS ERRORID, ROWID, 'A2SALEBRIS', 14, CURRENT_TIMESTAMP,371 , 'MODIFY'
FROM A2SALEMELB m
WHERE m.SHIPDATE < m.SALEDATE;
/
INSERT INTO A2ERROREVENT( ERRORID, SOURCE_ROWID, SOURCE_TABLE, FILTERID, DATETIME, ERRORCODE, ACTION )
SELECT A2ERROREVENT_SEQ.NEXTVAL AS ERRORID, ROWID, 'A2SALEBRIS', 15, CURRENT_TIMESTAMP,393 , 'MODIFY'
FROM A2SALEMELB m
WHERE m.UNITPRICE IS NULL;
